...
**"Publish the new site with 10 content pages, under 2s load time, and 3 inbound links within 4 weeks of launch" is a set of key results.** Each one is independently measurable, and together they describe what a successful launch actually looks like.
...
<Callout type="info">
An average score of 6-7 across your objectives is healthy — it means you're setting ambitious-but-achievable targets. Consistent 9-10 scores mean you're sandbagging. Consistent 3-4 scores mean something structural is broken in either the goal-setting or the execution system.
</Callout>
